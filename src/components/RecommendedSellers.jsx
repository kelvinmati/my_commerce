...
const RecommendedSellers = () => {
  ...
  return (
    <section className="bg-uniform_grey py-7">
      <p className="sm:text-2xl text-center pb-7 ">RECOMMENDED SELLERS</p>
      <div className="w-mobile md:w-container_width mx-auto  pt-3 grid grid-cols-2 md:grid-cols-4 gap-3 ">
        {loop.map((each, index) => (
          <div
            key={index}
          ...
          >
            ...
            <div className="w-full px-2">
              ...
              <button className="p-1 bg-green rounded-lg text-white">
                visit store
              </button>
            </div>
          </div>
